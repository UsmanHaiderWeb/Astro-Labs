                    ...
                    <div className='hidden group-data-[authenticated=true]:block'>
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                ...
                                /> */}
                                <svg viewBox="0 0 212 212" height="35" width="35" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px" enableBackground="new 0 0 212 212">
                                    <path fill="black" d="M106.251,0.5C164.653,0.5,212,47.846,212,106.25S164.653,212,106.25,212C47.846,212,0.5,164.654,0.5,106.25 S47.846,0.5,106.251,0.5z"></path>
                                    <g>
